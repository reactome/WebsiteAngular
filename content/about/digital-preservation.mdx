...
#### Reactome content:
  ...
  * Reactome data and resources are available for [direct download](<https://reactome.org/download-data>) from the Reactome website and from the [GitHub](<https://github.com/reactome/>) [r](<https://github.com/reactome-pwp/>)epository.
