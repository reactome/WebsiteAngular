...
##  [ Download our biological pathway knowledge in a PDF book ](</about/news/121-new-pdf-book>)

![Reactome book](/images/news/20190130_Reactome_book.png)
...
The full book can be downloaded from our [download](</download-data>) section. For an example of the on-demand download please visit the [Hemostasis details page](</content/detail/R-HSA-109582>) or [its view in the PathwayBrowser](</PathwayBrowser/#/R-HSA-109582>). All the above can be programmatically generated using [this method](</ContentService/#/exporter/eventPdfUsingGET>) from our [ContentService](</ContentService>).
