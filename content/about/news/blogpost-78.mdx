...
##  [ New Protein-protein Interaction files ](</about/news/79-new-protein-protein-interaction-files>)

![Interaction](/images/news/Interaction-nologo.png)
...
The four new files are:
  ...
  * [Full list of protein-protein interactions, incl. non-human species [PSI-MITAB]](</download/current/interactors/reactome.all_species.interactions.psi-mitab.txt>)
  * [Full list of protein-protein interactions, incl. non-human species [tab-delimited]](</download/current/interactors/reactome.all_species.interactions.tab-delimited.txt>)
  * [Human protein-protein interactions [PSI-MITAB]](</download/current/interactors/reactome.homo_sapiens.interactions.psi-mitab.txt>)
  * [Human protein-protein interactions [tab-delimited]](</download/current/interactors/reactome.homo_sapiens.interactions.tab-delimited.txt>).
