...
![gradient example](/images/ehldguide/gradient_example.png)
...
![microbe](/icon/R-ICO-013014.svg) |  _This**Microbe** element is formed by a circle with a radial gradient of two colours. To represent the membrane, we have added an outline with a different gradient. To convey the idea of danger we use this squares as spikes and a red shade in their gradients._  
---|---  
![macrophage](/icon/R-ICO-012969.svg) |  _We have drawn this**Macrophage** element with shaky tentacles and we have used a not uniform outline (membrane) to give it a soft and flexible feeling._  
![pathogen](/icon/R-ICO-013155.svg)![pathogen dead](/icon/R-ICO-013157.svg) |  _For this**Pathogen** element we used a large light gradient to represent a shiny and hard capsule._ _To show its death we draw holes on its surface and play with a darkened, sad colour._  
...
![atp](/icon/R-ICO-012399.svg) |  _We can use circles with or without outline._  
---|---  
![alpha toh](/icon/R-ICO-012413.svg) |  _We can use hexagons, in the same way as for the simple compounds, just adding a gradient on their stroke._  
...
![liver](/icon/R-ICO-012959.svg) |  ![blood vessel](/icon/R-ICO-012472.svg)  
---|---  
...
![calcium channel](/icon/R-ICO-012502.svg) |  ![proton channel](/icon/R-ICO-013251.svg)  
---|---  
...
![plc beta1](/icon/R-ICO-013194.svg) |  ![plasminogen](/icon/R-ICO-013189.svg)  
---|---  
...
![mac](/icon/R-ICO-012968.svg) |  ![antibody](/icon/R-ICO-012425.svg)  
---|---  
...
![FCgammaR](/icon/R-ICO-012710.svg) |  ![cd40-cd40l](/icon/R-ICO-012529.svg)  
---|---  
