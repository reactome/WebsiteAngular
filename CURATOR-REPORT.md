...
| V97 "other news" links, and links across the site                | The five links you found were five of 79 broken links to old reactome.org addresses, now all corrected (a few more wait on the new home for ReactomeGSA and on training slides being republished), and every build now checks every internal link. Three news items that showed broken images are mended            | About → News → V97 released               |
