...
| V97 "other news" links, and links across the site                | The five links you found were five of more than eighty broken links to old reactome.org addresses, now corrected. Every build checks every internal link, including links to a section of another page. A few wait on the new home for ReactomeGSA, which still opens on reactome.org meanwhile, and on training slides being republished. Three news items that showed broken images are mended | About → News → V97 released                                                  |
...
| Tour and Layout buttons missing from the menu bar                | They had never been carried over to the new browser. Both are in the top bar now and behave as on reactome.org: Tour plays the same Pathway Browser tour video, and Layout shows or hides the hierarchy and details panels, or expands the centre view                                                                                                                                           |
