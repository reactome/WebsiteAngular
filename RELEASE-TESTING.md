...
| No internal link leads to a missing page                                              | **auto** — `check-links.spec.ts` resolves all 3,800 links in content, navigation and templates against content files, routes and static files, never by fetching (a missing page answers 200). Links waiting on something are listed with their reason in `KNOWN_BROKEN`. _96 were broken, not the five reported_                                                       |
