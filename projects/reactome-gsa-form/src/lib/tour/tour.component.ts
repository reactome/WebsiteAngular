  ...
  constructor() {
    this.tourService.initialize([
      ...
      },
      {
        ...
        title: 'Search',
        content:
          'This option allow you to search across available datasets in ' +
      ...
      },
      {
        ...
        content:
          'In this step, you need to provide meta-data on the different samples in the dataset, like condition, gender, etc.<br> ' +
      ...
      },
      {
        ...
        content:
          'GSA analysis requires you to choose which factor, from the metadata, you want to compare between samples',
      ...
      },
      {
        ...
        title: 'Groups',
        content:
          'Among the different values you provided for the comparison factor, <br> ' +
      ...
      },
      {
        ...
        title: 'Cofactor',
        content:
          'The other factors you provided in the annotation step can have an impact on the result.<br>' +
      ...
      },
      {
        ...
        title: 'Options',
        content:
          'You can choose what type of output you want from your analysis using these options, <br>' +
