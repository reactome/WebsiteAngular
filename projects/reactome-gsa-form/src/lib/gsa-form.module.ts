...
import { ExampleDataComponent } from './dataset-form/datasets/select-dataset/dataset-types/example-data/example-data.component';
...
import { ExternalDataComponent } from './dataset-form/datasets/select-dataset/dataset-types/external-data/external-data.component';
...
@NgModule({
  ...
  providers: [TourUtilsService],
  exports: [GsaFormComponent],
