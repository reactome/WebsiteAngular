...
export function setDefaults(properties: UserProperties = {}, css: CSSStyleDeclaration): Properties {
  const global: Properties['global'] = defaultable(properties.global || {})
    ...
    .setDefault(
      'onPrimaryContainer',
      () => css.getPropertyValue('--on-primary-container') || '#001f29'
    )
  ...
  const genomeEncodedEntity: Properties['genomeEncodedEntity'] = defaultable(
    properties.genomeEncodedEntity || {}
  )
  ...
  const modification: Properties['modification'] = defaultable(
