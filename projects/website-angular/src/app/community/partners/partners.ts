...
export const REACTOME_PARTNERS: Partner[] = [
  ...
  },
  {
    ...
    description:
      'Tabloid Proteome is a database of protein association network generated using publicly available mass spectrometry based experiments in PRIDE.',
  ...
  },
  {
    name: 'iLINCS',
    description:
      'Integrative LINCS is an integrative web platform for analysis of LINCS data and signatures.',
  ...
  },
  {
    ...
    description:
      'Target-Pathogen database is a bioinformatic approach to prioritize and identify candidates drug targets for pathogens.',
  ...
  },
  {
    name: 'SimpliFi',
    description:
      'SimpliFi is an online, browser-accessible platform that translates omics data into biological understanding.',
  ...
  },
  {
    name: 'BioBox',
    description:
      'BioBox is a bio-data intelligence platform for drug discovery that helps research teams understand and interpret disease biology.',
    url: 'https://biobox.io/',
  ...
  },
  {
    name: 'oloBion',
    description:
      'oloBion is a science-driven CRO offering advanced omics services for industry and academia. oloBion accelerates research, enhances clinical outcomes, and deepens insights into the holobiont.',
