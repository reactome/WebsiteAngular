...
Currently, there are two options for integrating Reactome’s pathway diagrams in your web application. The first is to use our [DiagramJs widget](</documentation/dev/diagram/js>), while the second option involves using our [GWT implementation](</documentation/dev/diagram/gwt>).

[ __ ](</documentation/dev/diagram/js>)

##  [ Diagram JS ](</documentation/dev/diagram/js>)

[ __ ](</documentation/dev/diagram/gwt>)

##  [ Diagram GWT ](</documentation/dev/diagram/gwt>)

### [__API](<#API>)

Whether you are a JavaScript or GWT developer, we have a tool that will suit you. Check out your option:

[ __ ](</documentation/dev/diagram/js#API>)

##  [ Diagram JS API ](</documentation/dev/diagram/js#API>)

[ __ ](</documentation/dev/diagram/gwt#API>)

##  [ Diagram GWT API ](</documentation/dev/diagram/gwt#API>)

### [__Resources](<#Resources>)

  * __[Pathway Diagram Specifications](</documentation/dev/diagram/pathway-diagram-specs>)
