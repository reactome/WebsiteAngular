...
If you would like to download icons and Enhanced High Level Diagrams(EHLD), yes, we provide SVG format for both. Please visit our icon library [here](</community/icon-lib>), you can download any EHLDs in pathway browser by clicking the download button at the top right corner to export diagram to different formats including SVG.
