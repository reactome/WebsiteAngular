...
#### Reactome content:
  ...
  * Reactome data and resources are available for [direct download](/download-data) from the Reactome website, and on GitHub from the [reactome](<https://github.com/reactome/>) and [reactome-pwp](<https://github.com/reactome-pwp/>) repositories.
...
#### Reactome data, code and tools are robustly safeguarded by many levels of backup:
  ...
  * Legacy data and documentation for each release is additionally stored in the [Reactome Community](<https://zenodo.org/communities/reactome/records?q=&l=list&p=1&s=10&sort=newest>) on Zenodo
  * Reactome source code and the full data schema is preserved and available on Github. Archiving of Reactome code in the [Zenodo Reactome Community](<https://zenodo.org/communities/reactome/records?q=&l=list&p=1&s=10&sort=newest>) will be implemented by May 2026.
...
In the event that Reactome can no longer be actively maintained, OICR is committed to maintaining static copies of the Reactome database in internet-accessible storage repositories, as documented [here](<https://download.reactome.org/documentation/OICRcommitment.pdf>).
