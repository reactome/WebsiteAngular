...
This new feature has also been enabled in our [diagram](</documentation/dev/diagram>) and [pathways overview](</documentation/dev/pathways-overview>) widgets so third party web applications can already take advantage of it, allowing users to search Reactome content without abandoning the page they are in.
