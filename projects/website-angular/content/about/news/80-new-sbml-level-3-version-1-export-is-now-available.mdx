...
The SBML Level 3 Version 1 export is available for download here: [https://reactome.org/download/current/homo_sapiens.3.1.sbml.tgz](<https://download.reactome.org/{release}/homo_sapiens.3.1.sbml.tgz>).
