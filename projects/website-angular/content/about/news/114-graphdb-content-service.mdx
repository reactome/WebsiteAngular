...
Since version 57 we provide our data in a [Neo4j](<https://neo4j.com/>) [graph database](</documentation/dev/graph-database>) helping to reduce the complexity of the represented knowledgebase and allowing a more straightforward access to our content. Neo4j’s query language, Cypher, allows queries to be written in a more intuitive way and reduces the average response time per query by 93% ([Fabregat et al., 2018](<https://doi.org/10.1371/journal.pcbi.1005968>)).
