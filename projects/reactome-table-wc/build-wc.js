...
const build = async () => {
  ...
  await fs.copy(
    './dist/reactome-table-wc/browser/styles.css',
    'web-component-demo/reactome-table-styles.css'
  );
  await fs.copy(
    './projects/reactome-table/src/assets/fonts/RobotoMono.ttf',
    'web-component-demo/RobotoMono.ttf'
  );
